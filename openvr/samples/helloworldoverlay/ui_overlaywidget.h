...
public:
    ...
    void setupUi(QWidget *OverlayWidget)
    {
        ...
        spinBoxSpinBox->setObjectName(QStringLiteral("spinBoxSpinBox"));
        ...
        checkBoxesLabel->setObjectName(QStringLiteral("checkBoxesLabel"));

        formLayout->setWidget(1, QFormLayout::LabelRole, checkBoxesLabel);

        checkBoxesCheckBox = new QCheckBox(formLayoutWidget);
        checkBoxesCheckBox->setObjectName(QStringLiteral("checkBoxesCheckBox"));
    ...
    void retranslateUi(QWidget *OverlayWidget)
    {
        ...
        label->setText(QApplication::translate("OverlayWidget", "Hello World! This is an OpenVR System Overlay.", 0));
        spinBoxLabel->setText(QApplication::translate("OverlayWidget", "Spin Box:", 0));
        checkBoxesLabel->setText(QApplication::translate("OverlayWidget", "Check Boxes:", 0));
        pushButton->setText(QApplication::translate("OverlayWidget", "Quit Overlay", 0));
        pushButton_2->setText(QApplication::translate("OverlayWidget", "Do Nothing", 0));
    } // retranslateUi
