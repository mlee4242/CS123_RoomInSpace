...
//void Shader::setUniform(const ShaderVar &v) {
//   GLuint loc = m_uniforms[v.name];

//   switch(v.type) {
//       case ShaderVar::TEX1D:
//          bindTexture(v.tex, GL_TEXTURE_1D, loc);
//          break;
//       case ShaderVar::TEX2D:
//          bindTexture(v.tex, GL_TEXTURE_2D, loc);
//          break;
//       case ShaderVar::TEX3D:
//          bindTexture(v.tex, GL_TEXTURE_3D, loc);
//          break;
//       case ShaderVar::TEXCUBE:
//          bindTexture(v.tex, GL_TEXTURE_CUBE_MAP, loc);
//          break;
//   }
//}

void Shader::attachShaders(const std::vector<GLuint>& shaders) {
   std::for_each(shaders.begin(), shaders.end(), [this](int s) {
