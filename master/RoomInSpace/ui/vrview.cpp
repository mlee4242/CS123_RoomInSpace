...
/**
 * @brief VRView::getTrackedDeviceString
 * @param device
 * @param prop
 * @param error
 * @return
...
/**
 * @brief VRView::mouseReleaseEvent
 * @param event
 */
